    ...
    if(count($pages))
    {
      ...
      foreach($pages as $page)
      {
        echo '<tr>';
          ...
          echo '<td><a href="index.php?page=subject&subjectid=' . $page['Sujet'] . '&pageid=' . $page['Id'] .'&action=displaypage">'; if(isset($page['Mot-Clé'])) echo $page['Mot-Clé']; else echo 'Page d\'entrée'; echo '</a></td>';
